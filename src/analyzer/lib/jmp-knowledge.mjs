...
export async function loadJmpKnowledge(root){
  const base=path.join(root,'ui-maps/jmp/19.1/en-US');
  ...
  return {application:index.application,version:index.version,language:index.language,controls,apiCatalog:jmpApiCatalog()};
}
